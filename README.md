...
API Rest Microservice - Manager Products API Test

This README sets the use of this application to deploy the microservice API Rest.

### What is this application for? ###

* Management of Categories and Products data on a database.
  Retrieve, Create, Update, Delete data on database. 
* Version: v.1.21.H05.1
* [API Microservice Documentation](https://product-api-test.herokuapp.com/)

### How do I get set up/deploy it? ###

1.- Go to the GitHub remote repository: [GitHub remote microservice repository](https://github.com/jorgeMorfinezM/product_api_test.git) and validate the 
...
* [Repository Workspace](https://github.com/jorgeMorfinezM/product_api_test)
* [API Use Documentation](https://product-api-test.herokuapp.com/)